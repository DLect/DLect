 ...
 * @author lee
 */
public class ClassEventMatcher implements EventMatcher<DataEvent> {

    private final Class<?> clz;

    public ClassEventMatcher(Class<?> clz) {
        if (clz == null) {
    ...
    @Override
    public boolean supports(DataEvent e) {
    ...
    public boolean equals(Object obj) {
        ...
        final ClassEventMatcher other = (ClassEventMatcher) obj;
