 ...
 * @author lee
 */
public class DataListAddedClassEventMatcher implements EventMatcher<DataListEvent> {

    private final Class<?> addedClz;

    private final Class<?> clz;

    public DataListAddedClassEventMatcher(Class<?> clz, Class<?> addedClz) {
        if (clz == null) {
    ...
    public boolean supports(DataListEvent e) {
        ...
        return clz.equals(e.getOriginClass()) && addedClz.equals(e.getListClass());
    }
    ...
    public boolean equals(Object obj) {
        ...
        final DataListAddedClassEventMatcher other = (DataListAddedClassEventMatcher) obj;
