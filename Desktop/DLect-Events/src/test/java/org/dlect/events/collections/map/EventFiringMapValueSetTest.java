...
public class EventFiringMapValueSetTest {
    ...
    private Collection<String> testValues;

    @Before
    public void setUp() {
        map = Maps.newHashMap();
        testMap = new EventFiringMap<>(map, helper);
        testValues = testMap.values();
    ...
    public void testAddAll() {
        try {
            testValues.addAll(Lists.newArrayList("Hello", "World"));
            fail("No exception thrown");
        } catch (UnsupportedOperationException e) {
            verifyZeroInteractions(helper);
        }
    ...
    public void testRemove_Valid() {
        ...
        for (Entry<String, String> entry : content.entrySet()) {
            testValues.remove(entry.getValue());
    ...
    public void testRemove_Invalid() {
        ...
        testValues.remove("Brave New World");
    ...
    public void testRemoveAll_Valid() {
        ...
        testValues.removeAll(content.values());
    ...
    public void testRemoveAll_NotValid() {
        ...
        testValues.removeAll(toRemove.values());
    ...
    public void testRetainAll_NonRetained() {
        ...
        testValues.retainAll(toRetain.values());
    ...
    public void testRetainAll_AllRetained() {
        ...
        testValues.retainAll(content.values());

        assertFalse(map.isEmpty());
        assertFalse(testValues.isEmpty());
