 ...
 * class construction.
 */
public final class TextPromptFactory extends JLabel
        implements FocusListener, DocumentListener {

    public static void create(String text, JTextComponent component) {
        TextPromptFactory f = new TextPromptFactory(I18N.getString(text), component);
        f.changeAlpha(0.5f);
    }
    ...
    private TextPromptFactory(String text, JTextComponent component) {
        this(text, component, Show.ALWAYS);
    }

    private TextPromptFactory(String text, JTextComponent component, Show show) {
        ...
        component.setLayout(new GridLayout(1, 1, 0, 0));
        component.add(this);
        checkForPrompt();
    }
