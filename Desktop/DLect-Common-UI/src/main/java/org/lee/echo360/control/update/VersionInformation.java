...
import static org.lee.echo360.util.URLUtil.*;
...
public final class VersionInformation {
     ...
     */
    public static final String UPDATE_CHECKING_URL = BASE_URL + "/update.php?thisver=" + encode(APPLICATION_VERSION);
    /**
     ...
     */
    private static final String RUN_REGISTRATION_URL = BASE_URL + "/regRun.php?thisver=" + encode(APPLICATION_VERSION)
