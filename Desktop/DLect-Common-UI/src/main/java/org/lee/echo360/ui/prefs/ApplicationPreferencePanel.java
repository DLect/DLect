 ...
 * @author lee
 */
public class ApplicationPreferencePanel extends PreferencePanel implements ControllerListener {
    ...
    private void moveProperties(File f, File s, MainController c) {
        SwingWorkerProgressDialog swpd = new SwingWorkerProgressDialog(SwingUtilities.getWindowAncestor(this), new MoveWorker(f, s, c));
