...
import org.lee.echo360.ui.util.EnumComboBoxModel;
...
import org.lee.echo360.model.FormatType;
import org.lee.echo360.model.Formatter;
import org.lee.echo360.model.Lecture;
import org.lee.echo360.model.PlaylistFormatter;
import org.lee.echo360.model.Subject;
import org.lee.echo360.model.TagFormatter;
...
public class AdvancedPlaylistSettingsPanel extends javax.swing.JPanel implements ActionListener {
    ...
    private EnumMap<DownloadType, JComboBox> addDownloadTypeBoxes(final String postfix, GridBagConstraints gbc, boolean enabled, Formatter f) {
        ...
        for (DownloadType downloadType : DownloadType.values()) {
            ...
            ComboBoxModel m = new EnumComboBoxModel<FormatType>(FormatType.class, "None");
