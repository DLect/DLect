...
import org.lee.echo360.icon.LogoIconManager;
...
public abstract class AboutDialog extends javax.swing.JDialog {
    ...
    public AboutDialog() {
        ...
        logoLabel.setIcon(new ImageIcon(ImageUtils.scaleWidthWise(LogoIconManager.BLOCK.getImage(), dim)));
    }
    ...
    private void initComponents() {
        ...
        setMaximumSize(new java.awt.Dimension(420, 225));
        setMinimumSize(new java.awt.Dimension(420, 225));
        setPreferredSize(new java.awt.Dimension(420, 225));
        setResizable(false);
        ...
        versionLabel.setText("Version " + VersionInformation.APPLICATION_VERSION);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
