...
public class TestUQRotaParser {
    ...
    private static final LoadingCache<Integer, Sem> semesterInformationCache = CacheBuilder.newBuilder().softValues().build(new CacheLoader<Integer, Sem>() {
        @Override
