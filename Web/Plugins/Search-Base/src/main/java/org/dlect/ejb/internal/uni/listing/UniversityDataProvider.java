 ...
 * @author lee
 */
public interface UniversityDataProvider extends Prioritisable<UniversityDataProvider> {

    public abstract UniversityData getUniversityForCode(String code) throws DLectException;
