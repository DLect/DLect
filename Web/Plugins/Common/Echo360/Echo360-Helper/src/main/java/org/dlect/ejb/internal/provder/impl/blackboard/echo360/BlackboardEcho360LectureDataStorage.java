...
public interface BlackboardEcho360LectureDataStorage {
    ...
    /**
     * This method gets the {@linkplain CommonDataType#BASE_URL} for each Blackboard ID on the page given. It is recommended that the result
     * is cached for a short amount of time, as the methods that use this method do not perform any caching.
     *
     * @param lrUrl The plain lecture recording URL(Without anchor). If this is not a URL then an implementation may throw an
     *              ExecutionException.
     *
     * @return A Mapping between Blackboard IDs and the Base URL for the associated lecture recording.
     *
     * @throws java.util.concurrent.ExecutionException In the event of invalid parameters, or any problem loading the data. Use
